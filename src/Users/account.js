    ...
    <div className="w-50">
      ...
      {account && (
        <div className="">
          ...
          <select className="form-control mb-2" onChange={(e) => setAccount({
            ...account,
            role: e.target.value
          })}>
          ...
          <button className="btn btn-danger act-button w-100 mb-2" onClick={save}>
            Save
          </button>
          <Link to="../admin/users" className="btn btn-warning w-100 mb-2">
    Users
  </Link>
  <button className="btn btn-primary act-button w-100 mb-2" onClick={signout}>
    Signout
  </button>
        </div>
      )}
